...
export default function Footer(){
    return(
      <div className="bg-gradient-to-b from-green-100 to-green-500 pt-4 sm:pt-10 lg:pt-12 bg-bottom">
      <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="flex flex-col items-center justify-between gap-4 border-t border-b py-6 md:flex-row">
          ...
          <div className="flex gap-4">
            <a href="#" target="_blank" className="text-purple-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
