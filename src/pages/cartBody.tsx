      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <form className="mx-auto max-w-lg rounded-lg border">
          <div className="flex flex-col gap-4 p-4 md:p-8">
            <div>
              <label form="email" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Email</label>
            ...
            <div>
              <label form="password" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Password</label>
