...
export default function Faq() {
    ...
    <div className="flex flex-col min-h-screen  ">
        ...
        <h1 className="mb-4 text-center text-2xl font-bold text-purple-900 sm:text-3xl md:mb-6">＜予告＞アップデート情報</h1>
        <h3 className=" text-right pr-20 text-gray-500 sm:text-lg md:mb-8">2024/01/22</h3>
        <p className="mb-6 text-gray-500 sm:text-lg md:mb-8">
        本日は今後追加予定の機能を３つご紹介します！！<br/>
        </p>
        <h2 className="mb-2 text-xl font-semibold text-purple-900 sm:text-2xl md:mb-4">1. ネット記事などのブックマーク</h2>
        <p className="text-gray-500 sm:text-lg">ネットニュースや、ネットサーフィン中に見つけた興味のある記事をメモとともに保存することができます。</p>
        <br/>
        <br/>
        <h2 className="mb-2 text-xl font-semibold text-purple-900 sm:text-2xl md:mb-4">2. 外部サービスとのアカウント連携</h2>
        <p className="text-gray-500 sm:text-lg">Googleなどの外部サービスのアカウントを連携させることで、ブックマークの同期や興味をもった本の購入などができるようになります</p>
        <br/>
        <br/>
        <h2 className="mb-2 text-xl font-semibold text-purple-900 sm:text-2xl md:mb-4">3. 本棚の共有機能</h2>
