...
export default function Hello(){
  ...
  <header className="mb-8 border-b">
    <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
      ...
      <a href="./cart" className="flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24">
        ...
        <button type="button" onClick={handleButtonClick} className="flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24 lg:hidden">
          ...
          {isMenuOpen && (
          <div className="fixed top-0 left-0 right-0 bottom-0 bg-gray-800 opacity-75"></div>
        )}
        {isMenuOpen && (
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 text-black">
            {/* メニューの中身 */}
