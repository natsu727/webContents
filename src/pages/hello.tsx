...
export default function Hello(){
  ...
  const handleButtonClick = () => {
    ...
    return(
        <div className=" bg-green-50 pb-6 sm:pb-8 lg:pb-12">
  <header className="mb-8 border-b bg-gradient-to-t from-green-100 to-green-500">
    <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
      ...
      <a href="./mypage" className="flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-green-300 active:bg-green-200 sm:h-20 sm:w-20 md:h-24 md:w-24">
        ...
        <button type="button" onClick={handleButtonClick} className="flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-green-300 active:bg-green-200 sm:h-20 sm:w-20 md:h-24 md:w-24 lg:hidden">
  ...
  <section className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="mb-8 flex flex-wrap justify-between md:mb-16">
      <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
        <h1 className="mb-4 text-4xl font-bold text-purple-900 sm:text-5xl md:mb-8 md:text-6xl">Shear your<br />Book shelf</h1>
